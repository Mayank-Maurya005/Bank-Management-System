...
//		contentPane.add(btnAddAccount);
		...
		btnDepositToAccount.setBounds(217, 213, 194, 33);
		 btnDepositToAccount.setBackground(Color.WHITE);
		...
		btnWithdrawFromAccount.setBackground(Color.WHITE);
		...
		btnDisplayAccountList.setBackground(Color.WHITE);
		...
		lblNewLabel.setIcon(new ImageIcon(Menu.class.getResource("/img/download.png")));
		lblNewLabel.setBounds(0, 200, 230, 240);
